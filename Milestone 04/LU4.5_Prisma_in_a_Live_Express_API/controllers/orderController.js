...
async function listOrders(req, res, next) {
  try {
    // One Prisma query only. This log helps confirm the N+1 loop is gone.
    console.log("[orders] Executing a single Prisma query for order listing");
    ...
    console.log("[orders] Query count: 1");
