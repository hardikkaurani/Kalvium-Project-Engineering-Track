                        ...
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
                            ...
                            <div className="md:col-span-8 space-y-10">
                                ...
                                <div className="pt-10 flex flex-col md:flex-row gap-4 items-center border-t border-slate-100">
                                    {/* FIX 5: Conditional rendering based on permissions */}
                                    ...
                                    {event.hasRSVPed && (
                                        <div className="w-full md:flex-1 bg-green-50 text-green-700 font-bold py-4 rounded-xl flex items-center justify-center gap-2 border border-green-200 uppercase tracking-widest text-sm">
